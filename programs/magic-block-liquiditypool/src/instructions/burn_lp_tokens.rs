...
pub fn burn_lp_tokens(ctx: Context<BurnLpTokens>, burn_amount: u64) -> Result<()> {

    msg!("Burning {} LP tokens on-chain from provider", burn_amount);
    ...
    msg!("Successfully Burned {} LP tokens on-chain", burn_amount);
